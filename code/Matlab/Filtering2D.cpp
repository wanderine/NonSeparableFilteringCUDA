...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[])
{
    ...
    double          *convolution_time_texture, *convolution_time_texture_unrolled, *convolution_time_shared, *convolution_time_shared_unrolled;
    ...
    *convolution_time_texture_unrolled /= RUNS;
    ...
    *convolution_time_shared_unrolled /= RUNS;
